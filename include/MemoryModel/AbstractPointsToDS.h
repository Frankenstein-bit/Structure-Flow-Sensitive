...
public:
    ...
    ///@}
    //add dynamic_cast
    virtual inline bool varHasNewDFInPts(LocID loc,const Key& var){return false;}
    virtual inline bool varHasNewDFOutPts(LocID loc,const Key& var){return false;};
    ...
    ///@}
    //struct add.
    virtual bool updateATVPtsFromPts(const DataSet& srcDataSet, LocID dstLoc, const Key& dstVar) {
        return true;
    }
    /// Methods to support type inquiry through isa, cast, and dyn_cast:
    ///@{
