...
protected:
    ...
    virtual inline void solveWorklist()
    {
        ...
        {
            //std::cout<< "2222solveWorklist" <<"\n";
            NodeID nodeId = popFromWorklist();
            //std::cout<< "kkkksolveWorklist" <<"\n";
            collapsePWCNode(nodeId);
            // Keep solving until workList is empty.
            //std::cout<< "wwwwsolveWorklist" <<"\n";
            processNode(nodeId);
            //std::cout<< "solveWorklist" <<"\n";
            collapseFields();
            //std::cout<< "solveWorklist1111" <<"\n";
        }
    }
